...
class FDRmethodsTests(TestCase):
    def setUp(self):
        ...
        np.random.seed(31)
        self.data_sim, self.labels_sim = simulation.simulatedat(numsamples=10,numdiff=100,numc=100,
            numd=800,sigma=0.1,normalize=False,numreads=10000)

    def test_dsfdr(self):
        # test on dummy self.data
        res_ds = fdrmethods.dsfdr(self.data, self.labels, method='meandiff', transformtype='none', 
        ...
        res_bh = fdrmethods.dsfdr(self.data, self.labels, method='meandiff', transformtype='none', 
        ...
        res_by = fdrmethods.dsfdr(self.data, self.labels, method='meandiff', transformtype='none', 
        ...
        np.random.seed(31)
        res_ds2 = fdrmethods.dsfdr(self.data_sim, self.labels_sim, method='meandiff', transformtype='none', 
        ...
        np.random.seed(31)
        res_bh2 = fdrmethods.dsfdr(self.data_sim, self.labels_sim, method='meandiff', transformtype='none', 
        ...
        np.random.seed(31)
        res_by2 = fdrmethods.dsfdr(self.data_sim, self.labels_sim, method='meandiff', transformtype='none', 
